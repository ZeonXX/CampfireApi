...
class ModerationTagRemove : Moderation {

    var tagId = 0L
    var tagParentId = 0L
    var tagName = ""
    var tagImageId = 0L
    var tagParentName:String? = null
    var tagParentImageId = 0L

    override fun getType() = API.MODERATION_TYPE_TAG_REMOVE
    ...
    override fun json(inp: Boolean, json: Json): Json {
        ...
        tagParentName = json.mNull(inp, "tagParentName", tagParentName, String::class)
